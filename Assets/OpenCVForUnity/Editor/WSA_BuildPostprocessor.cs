...
public class WSA_BuildPostprocessor
{
	...
	private static void OnPostprocessBuildWSA(string pathToBuiltProject)
	{
		...
		string[] filesToSearch = new[] { "App.cpp", "App.xaml.cpp", "App.cs", "App.xaml.cs", "MainPage.xaml.cs", PlayerSettings.productName+".Shared/App.cpp", PlayerSettings.productName+".Shared/App.xaml.cpp", PlayerSettings.productName+".Shared/App.cs", PlayerSettings.productName+".Shared/App.xaml.cs", PlayerSettings.productName+".Shared/MainPage.xaml.cs" };
