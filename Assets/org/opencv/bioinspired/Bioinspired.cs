...
return null;
				...
				public static Retina createRetina (Size inputSize)
				{
						...
						Retina retVal = new Retina (bioinspired_Bioinspired_createRetina_10 (inputSize.width, inputSize.height));
...
return null;
				...
				public static Retina createRetina (Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrenght)
				{
						...
						Retina retVal = new Retina (bioinspired_Bioinspired_createRetina_11 (inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling, reductionFactor, samplingStrenght));
...
return null;
				...
				public static Retina createRetina (Size inputSize, bool colorMode)
				{
						...
						Retina retVal = new Retina (bioinspired_Bioinspired_createRetina_12 (inputSize.width, inputSize.height, colorMode));
...
return null;
		...
		// C++:  Ptr_Retina createRetina(Size inputSize)
		[DllImport("__Internal")]
		private static extern IntPtr bioinspired_Bioinspired_createRetina_10(double inputSize_width, double inputSize_height);
		
		// C++:  Ptr_Retina createRetina(Size inputSize, bool colorMode, int colorSamplingMethod = RETINA_COLOR_BAYER, bool useRetinaLogSampling = false, float reductionFactor = 1.0f, float samplingStrenght = 10.0f)
		[DllImport("__Internal")]
		private static extern IntPtr bioinspired_Bioinspired_createRetina_11(double inputSize_width, double inputSize_height, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrenght);
		[DllImport("__Internal")]
		private static extern IntPtr bioinspired_Bioinspired_createRetina_12(double inputSize_width, double inputSize_height, bool colorMode);
