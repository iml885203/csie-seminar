...
return;
				...
				public  Mat getMagnoRAW ()
				{
						...
						Mat retVal = new Mat (bioinspired_Retina_getMagnoRAW_11 (nativeObj));
...
return false;
				...
				public  Mat getParvoRAW ()
				{
						...
						Mat retVal = new Mat (bioinspired_Retina_getParvoRAW_11 (nativeObj));
...
return;
		...
		// C++:  Size getInputSize()
		[DllImport("__Internal")]
		private static extern void bioinspired_Retina_getInputSize_10 (IntPtr nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);
		
		// C++:  Size getOutputSize()
		[DllImport("__Internal")]
		private static extern void bioinspired_Retina_getOutputSize_10 (IntPtr nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);
